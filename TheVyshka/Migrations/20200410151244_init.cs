    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostCollaborators", x => new { x.PostId, x.CollaboratorId, x.Role });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4144fafc-976c-4aa5-9fbb-ab6006cbd90d"), "9ad527be-1b48-466b-a78b-f3421e02ff01", "admin", "ADMIN" },
                    { new Guid("1022a447-e517-4bdc-86d5-0d75f862703e"), "89555e9a-70ce-4a9d-9f9a-2c5c2c9170c2", "editor", "EDITOR" }
                });
